...
public class Abastecimento implements Serializable {
    ...
    */
    @ManyToOne
    @JoinColumn(name="fk_carro", nullable = false, referencedColumnName = "id", insertable=true, updatable=true, foreignKey = @ForeignKey(name = ""))
    ...
    */
    @ManyToOne
    @JoinColumn(name="fk_posto", nullable = false, referencedColumnName = "id", insertable=true, updatable=true, foreignKey = @ForeignKey(name = ""))
    ...
    * @generated
    */
    @Column(name = "valor", nullable = false, unique = false, length=8, precision=2, insertable=true, updatable=true)
    ...
    * @generated
    */
    @Column(name = "precoLitro", nullable = false, unique = false, length=8, precision=2, insertable=true, updatable=true)
    ...
    * @generated
    */
    @Column(name = "km", nullable = false, unique = false, length=8, insertable=true, updatable=true)
